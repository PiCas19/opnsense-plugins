...
<script>
   $( document ).ready(function() {
      ...
      $('#btnSaveProtocols').unbind('click').click(function(){
         ...
         saveFormToEndpoint("/api/deepinspector/settings/setProtocols/", frm_id, function(){
            isSubsystemDirty();
         }, true);
      ...
      $('#btnSaveDetection').unbind('click').click(function(){
         ...
         saveFormToEndpoint("/api/deepinspector/settings/setDetection/", frm_id, function(){
            isSubsystemDirty();
         }, true);
      ...
      $('#btnSaveAdvanced').unbind('click').click(function(){
         ...
         saveFormToEndpoint("/api/deepinspector/settings/setAdvanced/", frm_id, function(){
            isSubsystemDirty();
         }, true);
